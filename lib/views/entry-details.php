...
<div class="wrap entry-detail-page cf7-entry-page"> 
    <h2>Ninja Forms Entries Listing</h2>
    <div class="tablenav top">
        <form action="" method="get">
            <input type="hidden" name="page" value="ninja-form-entries">
            ...
            <table id="entryTable" class="striped widefat">
                ...
                <tbody>
                    ...
                    foreach ($formData as $row): ?>
                        <tr>
                            <td><?php echo $row['nf_entry_id']; ?></td>
...
<script>
    jQuery(document).ready( function ($) {
        ...
        $('#toplevel_page_manage-nf-entries').addClass('current');
        $('#toplevel_page_manage-nf-entries a').addClass('current');
    });
</script>